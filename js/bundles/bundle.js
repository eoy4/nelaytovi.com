...
/***/ function(module, exports, __webpack_require__) {
	...
	function countdown(el) {
	  ...
	  var $days = $countdown.find('.box.days');
	  var $hours = $countdown.find('.box.hours');
	  var $minutes = $countdown.find('.box.minutes');
	  var $seconds = $countdown.find('.box.seconds');

	  var interval = setInterval(function () {
	    var stamp = (0, _moment2.default)();
	    var then = (0, _moment2.default)('2017/03/18 18:30:00', 'YYYY/MM/DD HH:mm:ss');
	    var d = Math.floor(then.diff(stamp, 'seconds') / 60 / 60 / 24);
	    var h = Math.floor(then.diff(stamp, 'seconds') / 60 / 60 - d * 24);
	    var m = Math.floor(then.diff(stamp, 'seconds') / 60 - h * 60 - d * 24 * 60);
	    var s = then.diff(stamp, 'seconds') - d * 24 * 60 * 60 - h * 60 * 60 - m * 60;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!locales[name]&&typeof module!=='undefined'&&module&&module.exports){try{oldLocale=globalLocale._abbr;__webpack_require__(4)("./"+name);// because defineLocale currently also sets the global locale, we
